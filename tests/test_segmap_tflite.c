...
#define TFLITE_MODEL_FILE "deeplabv3_mnv2_pascal_train_aug.tflite"
...
main (int argc, char ** argv)
{
  ...
  g_app.sample_handler = &handle_segmap_sample;
  ...
  g_signal_connect (g_app.tensor_res, "draw", G_CALLBACK (draw_segmap_overlay_cb), NULL);
